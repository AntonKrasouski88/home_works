...
function Clock() {
    ...
    const stringDay = new Intl.DateTimeFormat('en-US', {weekday: "long"}).format(date.getDate()) || <br/> // пишут студенты
    const stringMonth = new Intl.DateTimeFormat('en-US', {month: 'long'}).format(date.getMonth()) || <br/> // пишут студенты
        ...
        <div className={s.clock}>
            ...
            <div className={s.buttonsContainer}>
                <SuperButton
                    ...
                    onClick={start}
                    className={s.additionallyClassButton}
                >
                    start
                </SuperButton>
                <SuperButton
                    ...
                    onClick={stop}
                    className={s.additionallyClassButton + ` `+ s.rightButton}
                >
                    stop
                </SuperButton>
            </div>
